...
return [(function (){var pred__51922 = cljs.core.instance_QMARK_;
var expr__51923 = reactive_val;
if(cljs.core.truth_((pred__51922.cljs$core$IFn$_invoke$arity$2 ? pred__51922.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RAtom,expr__51923) : pred__51922.call(null,reagent.ratom.RAtom,expr__51923)))){
return "ra";
} else {
if(cljs.core.truth_((pred__51922.cljs$core$IFn$_invoke$arity$2 ? pred__51922.cljs$core$IFn$_invoke$arity$2(reagent.ratom.RCursor,expr__51923) : pred__51922.call(null,reagent.ratom.RCursor,expr__51923)))){
return "rc";
} else {
if(cljs.core.truth_((pred__51922.cljs$core$IFn$_invoke$arity$2 ? pred__51922.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Reaction,expr__51923) : pred__51922.call(null,reagent.ratom.Reaction,expr__51923)))){
return "rx";
} else {
if(cljs.core.truth_((pred__51922.cljs$core$IFn$_invoke$arity$2 ? pred__51922.cljs$core$IFn$_invoke$arity$2(reagent.ratom.Track,expr__51923) : pred__51922.call(null,reagent.ratom.Track,expr__51923)))){
return "tr";
} else {
return "other";
}
