...
rewrite_clj.zip.utils.update_in_path = (function rewrite_clj$zip$utils$update_in_path(p__49802,k,f){
var vec__49804 = p__49802;
var node = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49804,(0),null);
var path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49804,(1),null);
var loc = vec__49804;
...
var G__49851 = clojure.zip.remove(zloc__$1);
zloc__$1 = G__49851;
continue;
}
break;
...
var G__49854 = rewrite_clj.zip.utils.remove_right(zloc__$1);
zloc__$1 = G__49854;
continue;
} else {
return zloc__$1;
...
var G__49855 = rewrite_clj.zip.utils.remove_left(zloc__$1);
zloc__$1 = G__49855;
continue;
} else {
return zloc__$1;
 ...
 */
rewrite_clj.zip.utils.remove_and_move_left = (function rewrite_clj$zip$utils$remove_and_move_left(p__49813){
var vec__49814 = p__49813;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49814,(0),null);
var map__49817 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49814,(1),null);
...
var path = map__49817__$1;
var l = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49817__$1,new cljs.core.Keyword(null,"l","l",1395893423));
var loc = vec__49814;
if(cljs.core.seq(l)){
 ...
 * location, returns `nil`.
 */
rewrite_clj.zip.utils.remove_and_move_right = (function rewrite_clj$zip$utils$remove_and_move_right(p__49821){
var vec__49822 = p__49821;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49822,(0),null);
var map__49825 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49822,(1),null);
var map__49825__$1 = (((((!((map__49825 == null))))?(((((map__49825.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49825.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49825):map__49825);
var path = map__49825__$1;
var r = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49825__$1,new cljs.core.Keyword(null,"r","r",-471384190));
var loc = vec__49822;
if(cljs.core.seq(r)){
...
var rs = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49843__$1,new cljs.core.Keyword(null,"r","r",-471384190));
if((path == null)){
