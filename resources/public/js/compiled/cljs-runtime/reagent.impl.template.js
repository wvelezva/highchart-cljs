...
var G__51453 = o;
(G__51453[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__51580__delegate = function (args){
...
while (G__51581__i < G__51581__a.length) {G__51581__a[G__51581__i] = arguments[G__51581__i + 0]; ++G__51581__i;}
  args = new cljs.core.IndexedSeq(G__51581__a,0,null);
} 
return G__51580__delegate.call(this,args);};
G__51580.cljs$lang$maxFixedArity = 0;
G__51580.cljs$lang$applyTo = (function (arglist__51582){
var args = cljs.core.seq(arglist__51582);
return G__51580__delegate(args);
});
...
var G__51458 = o;
(G__51458[reagent.impl.template.cached_custom_prop_name(k)] = reagent.impl.template.convert_prop_value(v));
...
while (G__51588__i < G__51588__a.length) {G__51588__a[G__51588__i] = arguments[G__51588__i + 0]; ++G__51588__i;}
  args = new cljs.core.IndexedSeq(G__51588__a,0,null);
} 
...
var args = cljs.core.seq(arglist__51589);
...
var G__51472 = props;
var G__51472__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51472,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__51472);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__51472__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__51474){
...
var props = map__51475__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51475__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__51481){
...
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__51482__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
var G__51489 = jsprops;
(G__51489["defaultValue"] = value);

(G__51489["onChange"] = (function (p1__51487_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__51487_SHARP_);
}));
...
var vec__51496 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51496,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51496,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51496,(2),null);
...
var jsprops = ({"argv": v});
var temp__5739__auto___51619 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___51619 == null)){
} else {
var key_51620 = temp__5739__auto___51619;
(jsprops["key"] = key_51620);
}
...
var temp__5739__auto___51623 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___51623 == null)){
} else {
var key_51625 = temp__5739__auto___51623;
reagent.impl.template.oset(jsprops,"key",key_51625);
}
...
var G__51510 = reagent.impl.template.__GT_NativeWrapper();
(G__51510["name"] = c);
...
var G__51553 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__51553) : reagent.impl.template.as_element.call(null,G__51553));
} else {
...
var len__4789__auto___51631 = arguments.length;
var i__4790__auto___51632 = (0);
while(true){
if((i__4790__auto___51632 < len__4789__auto___51631)){
args__4795__auto__.push((arguments[i__4790__auto___51632]));

var G__51634 = (i__4790__auto___51632 + (1));
i__4790__auto___51632 = G__51634;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq51556){
var G__51557 = cljs.core.first(seq51556);
var seq51556__$1 = cljs.core.next(seq51556);
var self__4776__auto__ = this;
return self__4776__auto__.cljs$core$IFn$_invoke$arity$variadic(G__51557,seq51556__$1);
}));
...
break;
default:
var G__51645 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__51645;
continue;
...
var n__4666__auto___51648 = a.length;
var i_51649 = (0);
while(true){
if((i_51649 < n__4666__auto___51648)){
(a[i_51649] = reagent.impl.template.as_element((a[i_51649])));

var G__51651 = (i_51649 + (1));
i_51649 = G__51651;
continue;
} else {
}
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__4666__auto___51653 = a.length;
var i_51654 = (0);
while(true){
if((i_51654 < n__4666__auto___51653)){
var val_51656 = (a[i_51654]);
if(((cljs.core.vector_QMARK_(val_51656)) && ((reagent.impl.template.key_from_vec(val_51656) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_51654] = reagent.impl.template.as_element(val_51656));

var G__51659 = (i_51654 + (1));
i_51654 = G__51659;
continue;
} else {
}
...
var ctx = ({});
var vec__51562 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51562,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__51562,(1),null);
...
var G__51569 = (cljs.core.count(argv) - first_child);
switch (G__51569) {
case (0):
...
case (1):
var G__51572 = comp;
var G__51573 = jsprops;
var G__51574 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return module$node_modules$react$index.createElement(G__51572,G__51573,G__51574);
