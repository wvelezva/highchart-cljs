...
}catch (e45309){var _e__40405__auto__ = e45309;
return false;
...
}catch (e45313){var _e__40405__auto__ = e45313;
return false;
...
}catch (e45322){var _e__40405__auto__ = e45322;
return false;
...
}catch (e45329){var _e__40405__auto__ = e45329;
return false;
...
}catch (e45340){var _e__40405__auto__ = e45340;
return false;
}})())){
...
}catch (e45344){var _e__40405__auto__ = e45344;
return false;
}})())){
...
var _STAR_current_state_STAR__orig_val__45363 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__45364 = (function (){var or__4185__auto__ = config;
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
...
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__45364);

try{return (raw_fn.cljs$core$IFn$_invoke$arity$1 ? raw_fn.cljs$core$IFn$_invoke$arity$1(value) : raw_fn.call(null,value));
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__45363);
}});
});
...
while (G__45400__i < G__45400__a.length) {G__45400__a[G__45400__i] = arguments[G__45400__i + 0]; ++G__45400__i;}
  args = new cljs.core.IndexedSeq(G__45400__a,0,null);
} 
return G__45398__delegate.call(this,args);};
G__45398.cljs$lang$maxFixedArity = 0;
G__45398.cljs$lang$applyTo = (function (arglist__45401){
var args = cljs.core.seq(arglist__45401);
