...
if((c === "\n")){
var G__49622 = escape_QMARK_;
var G__49623 = rewrite_clj.parser.string.flush_into(lines,buf);
escape_QMARK_ = G__49622;
lines = G__49623;
continue;
} else {
buf.append(c);

var G__49624 = ((cljs.core.not(escape_QMARK_)) && ((c === "\\")));
var G__49625 = lines;
escape_QMARK_ = G__49624;
lines = G__49625;
continue;
...
var G__49611 = rewrite_clj.parser.string.read_string_data(reader);
return (rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1 ? rewrite_clj.node.string_node.cljs$core$IFn$_invoke$arity$1(G__49611) : rewrite_clj.node.string_node.call(null,G__49611));
});
...
var G__49614 = cljs.core.re_pattern(regex);
var G__49615 = ["#\"",regex,"\""].join('');
return (rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2 ? rewrite_clj.node.token_node.cljs$core$IFn$_invoke$arity$2(G__49614,G__49615) : rewrite_clj.node.token_node.call(null,G__49614,G__49615));
});
