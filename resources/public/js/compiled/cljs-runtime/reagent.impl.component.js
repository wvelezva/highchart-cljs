...
if((i < len)){
var k = (ks[i]);
var G__51432 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__51433 = (i + (1));
m = G__51432;
i = G__51433;
continue;
...
var temp__5737__auto__ = (p["argv"]);
if((temp__5737__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__51283 = (p["children"]);
return module$node_modules$react$index.Children.toArray(G__51283);
})());
} else {
var v = temp__5737__auto__;
...
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51289 = c;
var G__51289__$1 = (((G__51289 == null))?null:G__51289.prototype);
if((G__51289__$1 == null)){
return null;
} else {
return (G__51289__$1["reagentRender"]);
}
})() == null)))));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return ((cljs.core.fn_QMARK_(c)) && ((!(((function (){var G__51293 = c;
var G__51293__$1 = (((G__51293 == null))?null:G__51293.prototype);
if((G__51293__$1 == null)){
return null;
} else {
return (G__51293__$1["render"]);
}
})() == null)))));
});
...
return (function() { 
var G__51440__delegate = function (args){
var G__51316 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__51316) : reagent.impl.component.as_element.call(null,G__51316));
};
...
while (G__51444__i < G__51444__a.length) {G__51444__a[G__51444__i] = arguments[G__51444__i + 0]; ++G__51444__i;}
  args = new cljs.core.IndexedSeq(G__51444__a,0,null);
} 
return G__51440__delegate.call(this,args);};
G__51440.cljs$lang$maxFixedArity = 0;
G__51440.cljs$lang$applyTo = (function (arglist__51445){
var args = cljs.core.seq(arglist__51445);
return G__51440__delegate(args);
});
...
var _STAR_current_component_STAR__orig_val__51318 = reagent.impl.component._STAR_current_component_STAR_;
var _STAR_current_component_STAR__temp_val__51319 = c;
(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__temp_val__51319);
...
}finally {(reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR__orig_val__51318);
}});
...
var c = this;
var G__51325_51454 = (c["cljsRatom"]);
if((G__51325_51454 == null)){
} else {
reagent.ratom.dispose_BANG_(G__51325_51454);
}
...
var renders_51460 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"render","render",-1408033454),new cljs.core.Keyword(null,"reagentRender","reagentRender",-358306383),new cljs.core.Keyword(null,"componentFunction","componentFunction",825866104)], null));
var render_fun_51461 = cljs.core.first(cljs.core.vals(renders_51460));
if((cljs.core.count(renders_51460) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_51460))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_51461)){
} else {
throw (new Error(["Assert failed: ",["Expected something callable, not ",cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_51461], 0))].join(''),"\n","(clojure.core/ifn? render-fun)"].join('')));
}
...
var name__$1 = (function (){var G__51362 = name;
switch (G__51362) {
case "":
...
var G__51380 = reagent.impl.component.cljsify(body);
return module$node_modules$create_react_class$index(G__51380);
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__51395 = fiber;
var G__51395__$1 = (((G__51395 == null))?null:(G__51395["type"]));
if((G__51395__$1 == null)){
return null;
} else {
return (G__51395__$1["displayName"]);
}
})();
var parent = (function (){var G__51396 = fiber;
if((G__51396 == null)){
return null;
} else {
return (G__51396["return"]);
}
})();
var path = (function (){var G__51397 = parent;
var G__51397__$1 = (((G__51397 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__51397) : reagent.impl.component.fiber_component_path.call(null,G__51397)));
if((G__51397__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51397__$1)," > "].join('');
}
})();
...
var temp__5733__auto__ = (function (){var or__4185__auto__ = (function (){var G__51401 = c;
if((G__51401 == null)){
return null;
} else {
return (G__51401["_reactInternalFiber"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__51402._reactInternalFiber;
}
}
})();
...
var instance = (function (){var or__4185__auto__ = (function (){var G__51404 = c;
if((G__51404 == null)){
return null;
} else {
return (G__51404["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var or__4185__auto____$1 = (function (){var G__51406 = c;
if((G__51406 == null)){
return null;
} else {
return G__51406._reactInternalInstance;
}
})();
...
var elem = (function (){var or__4185__auto__ = (function (){var G__51408 = instance;
if((G__51408 == null)){
return null;
} else {
return (G__51408["_currentElement"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
} else {
var G__51409 = instance;
if((G__51409 == null)){
return null;
} else {
return G__51409._currentElement;
}
}
})();
var name = (function (){var G__51410 = elem;
var G__51410__$1 = (((G__51410 == null))?null:(G__51410["type"]));
if((G__51410__$1 == null)){
return null;
} else {
return (G__51410__$1["displayName"]);
}
})();
var owner = (function (){var or__4185__auto__ = (function (){var G__51412 = elem;
if((G__51412 == null)){
return null;
} else {
return (G__51412["_owner"]);
}
})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
return G__51416._owner;
}
}
})();
var path = (function (){var G__51419 = owner;
var G__51419__$1 = (((G__51419 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__51419) : reagent.impl.component.component_path.call(null,G__51419)));
if((G__51419__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__51419__$1)," > "].join('');
}
})();
var res = [path,cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var G__51421 = c;
var G__51421__$1 = (((G__51421 == null))?null:G__51421.constructor);
if((G__51421__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__51421__$1);
}
}
})();
