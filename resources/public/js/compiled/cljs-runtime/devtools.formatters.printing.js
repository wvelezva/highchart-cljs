...
var G__41954 = (i__4790__auto___41952 + (1));
i__4790__auto___41952 = G__41954;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq41867){
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__41912_SHARP_){
return (!((cljs.core.meta(p1__41912_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41925__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e41929){var _e__40405__auto__ = e41929;
return false;
}})();
if(cljs.core.truth_(or__4185__auto__)){
return or__4185__auto__;
...
}catch (e41931){var _e__40405__auto__ = e41931;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__41933 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__41934 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__41934);

try{var map__41935 = opts;
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__41935__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__41933);
}});
...
var temp__5733__auto___41981 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5733__auto___41981)){
var managed_print_level_41985 = temp__5733__auto___41981;
var _STAR_print_level_STAR__orig_val__41942_41986 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__41943_41987 = managed_print_level_41985;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__41943_41987);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__41937_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__41937_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__41942_41986);
}} else {
job_fn();
}
