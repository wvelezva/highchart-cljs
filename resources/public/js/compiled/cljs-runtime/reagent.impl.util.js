...
var vec__51023 = clojure.string.split.cljs$core$IFn$_invoke$arity$2(name_str,/-/);
...
var start = first__51025;
var parts = seq__51024__$1;
...
(reagent.impl.util.PartialFn.prototype.call = (function (unused__10523__auto__){
var self__ = this;
var self__ = this;
var G__51035 = (arguments.length - (1));
switch (G__51035) {
case (0):
...
(reagent.impl.util.PartialFn.prototype.apply = (function (self__,args51034){
var self__ = this;
var self____$1 = this;
return self____$1.call.apply(self____$1,[self____$1].concat(cljs.core.aclone(args51034)));
}));
...
var _STAR_always_update_STAR__orig_val__51055 = reagent.impl.util._STAR_always_update_STAR_;
var _STAR_always_update_STAR__temp_val__51056 = true;
(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__temp_val__51056);

try{return (comp["forceUpdate"])();
}finally {(reagent.impl.util._STAR_always_update_STAR_ = _STAR_always_update_STAR__orig_val__51055);
}} else {
