...
return [(function (){var pred__47509 = cljs.core.instance_QMARK_;
var expr__47510 = reactive_val;
if(cljs.core.truth_((pred__47509.cljs$core$IFn$_invoke$arity$2 ? pred__47509.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__47510) : pred__47509.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RAtom,expr__47510)))){
return "ra";
} else {
if(cljs.core.truth_((pred__47509.cljs$core$IFn$_invoke$arity$2 ? pred__47509.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__47510) : pred__47509.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.RCursor,expr__47510)))){
return "rc";
} else {
if(cljs.core.truth_((pred__47509.cljs$core$IFn$_invoke$arity$2 ? pred__47509.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__47510) : pred__47509.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Reaction,expr__47510)))){
return "rx";
} else {
if(cljs.core.truth_((pred__47509.cljs$core$IFn$_invoke$arity$2 ? pred__47509.cljs$core$IFn$_invoke$arity$2(mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__47510) : pred__47509.call(null,mranderson048.reagent.v0v8v0.reagent.ratom.Track,expr__47510)))){
return "tr";
} else {
return "other";
}
