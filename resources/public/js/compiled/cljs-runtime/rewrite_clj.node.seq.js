...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k49129,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49129,else__4442__auto__);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (ret__4461__auto__,p__49155){
var vec__49158 = p__49155;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49158,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49158,(1),null);
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49128){
var self__ = this;
var G__49128__$1 = this;
return (new cljs.core.RecordIter((0),G__49128__$1,5,new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"tag","tag",-1290361223),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__49170 = (function (coll__4436__auto__){
return (580297420 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__49170(this__4435__auto____$1);
})();
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49130,other49131){
var self__ = this;
var this49130__$1 = this;
return (((!((other49131 == null)))) && ((this49130__$1.constructor === other49131.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49130__$1.tag,other49131.tag)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49130__$1.wrap_fn,other49131.wrap_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49130__$1.wrap_length,other49131.wrap_length)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49130__$1.seq_fn,other49131.seq_fn)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49130__$1.children,other49131.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49130__$1.__extmap,other49131.__extmap)));
}));
...
var self__ = this;
var this$__$1 = this;
var G__49210 = rewrite_clj.node.protocols.sexprs(self__.children);
return (self__.seq_fn.cljs$core$IFn$_invoke$arity$1 ? self__.seq_fn.cljs$core$IFn$_invoke$arity$1(G__49210) : self__.seq_fn.call(null,G__49210));
}));
...
var self__ = this;
var this$__$1 = this;
var G__49220 = rewrite_clj.node.protocols.concat_strings(self__.children);
return (self__.wrap_fn.cljs$core$IFn$_invoke$arity$1 ? self__.wrap_fn.cljs$core$IFn$_invoke$arity$1(G__49220) : self__.wrap_fn.call(null,G__49220));
}));
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__49128){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__49240 = cljs.core.keyword_identical_QMARK_;
var expr__49241 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__49243 = new cljs.core.Keyword(null,"tag","tag",-1290361223);
var G__49244 = expr__49241;
return (pred__49240.cljs$core$IFn$_invoke$arity$2 ? pred__49240.cljs$core$IFn$_invoke$arity$2(G__49243,G__49244) : pred__49240.call(null,G__49243,G__49244));
})())){
return (new rewrite_clj.node.seq.SeqNode(G__49128,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49245 = new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130);
var G__49246 = expr__49241;
return (pred__49240.cljs$core$IFn$_invoke$arity$2 ? pred__49240.cljs$core$IFn$_invoke$arity$2(G__49245,G__49246) : pred__49240.call(null,G__49245,G__49246));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,G__49128,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49247 = new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519);
var G__49248 = expr__49241;
return (pred__49240.cljs$core$IFn$_invoke$arity$2 ? pred__49240.cljs$core$IFn$_invoke$arity$2(G__49247,G__49248) : pred__49240.call(null,G__49247,G__49248));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,G__49128,self__.seq_fn,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49249 = new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231);
var G__49250 = expr__49241;
return (pred__49240.cljs$core$IFn$_invoke$arity$2 ? pred__49240.cljs$core$IFn$_invoke$arity$2(G__49249,G__49250) : pred__49240.call(null,G__49249,G__49250));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,G__49128,self__.children,self__.__meta,self__.__extmap,null));
} else {
if(cljs.core.truth_((function (){var G__49253 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__49254 = expr__49241;
return (pred__49240.cljs$core$IFn$_invoke$arity$2 ? pred__49240.cljs$core$IFn$_invoke$arity$2(G__49253,G__49254) : pred__49240.call(null,G__49253,G__49254));
})())){
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,G__49128,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__49128),null));
}
}
}
}
...
(rewrite_clj.node.seq.SeqNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__49128){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.seq.SeqNode(self__.tag,self__.wrap_fn,self__.wrap_length,self__.seq_fn,self__.children,G__49128,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.seq.map__GT_SeqNode = (function rewrite_clj$node$seq$map__GT_SeqNode(G__49135){
var extmap__4478__auto__ = (function (){var G__49309 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$variadic(G__49135,new cljs.core.Keyword(null,"tag","tag",-1290361223),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231),new cljs.core.Keyword(null,"children","children",-940561982)], 0));
if(cljs.core.record_QMARK_(G__49135)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49309);
} else {
return G__49309;
}
})();
return (new rewrite_clj.node.seq.SeqNode(new cljs.core.Keyword(null,"tag","tag",-1290361223).cljs$core$IFn$_invoke$arity$1(G__49135),new cljs.core.Keyword(null,"wrap-fn","wrap-fn",-270233130).cljs$core$IFn$_invoke$arity$1(G__49135),new cljs.core.Keyword(null,"wrap-length","wrap-length",-268108519).cljs$core$IFn$_invoke$arity$1(G__49135),new cljs.core.Keyword(null,"seq-fn","seq-fn",-991013231).cljs$core$IFn$_invoke$arity$1(G__49135),new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__49135),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"list","list",765357683),rewrite_clj.node.seq.wrap_list,(2),(function (p1__49329_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,p1__49329_SHARP_);
}),children);
});
/**
...
return rewrite_clj.node.seq.__GT_SeqNode(new cljs.core.Keyword(null,"map","map",1371690461),rewrite_clj.node.seq.wrap_map,(2),(function (p1__49343_SHARP_){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,p1__49343_SHARP_);
}),children);
});
