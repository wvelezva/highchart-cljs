...
var G__41851 = devtools.prefs.pref(v);
v = G__41851;
continue;
} else {
return v;
...
}catch (e41800){var _e__40405__auto__ = e41800;
return false;
}})();
...
}catch (e41808){var _e__40405__auto__ = e41808;
return false;
}})();
...
}catch (e41814){var _e__40405__auto__ = e41814;
return false;
}}
}
});
...
var vec__41835 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41835,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__41835,(1),null);
...
return cljs.core.some((function (p1__41844_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__41844_SHARP_);
}),template);
});
