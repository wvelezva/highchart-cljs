...
var syms = (function (){var iter__4582__auto__ = (function rewrite_clj$node$fn$fn_walk_$_iter__49051(s__49052){
return (new cljs.core.LazySeq(null,(function (){
var s__49052__$1 = s__49052;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__49052__$1);
if(temp__5735__auto__){
var s__49052__$2 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(s__49052__$2)){
var c__4580__auto__ = cljs.core.chunk_first(s__49052__$2);
var size__4581__auto__ = cljs.core.count(c__4580__auto__);
var b__49054 = cljs.core.chunk_buffer(size__4581__auto__);
if((function (){var i__49053 = (0);
while(true){
if((i__49053 < size__4581__auto__)){
var i = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4580__auto__,i__49053);
...
cljs.core.chunk_append(b__49054,cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')));

var G__49188 = (i__49053 + (1));
i__49053 = G__49188;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__49054),rewrite_clj$node$fn$fn_walk_$_iter__49051(cljs.core.chunk_rest(s__49052__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__49054),null);
}
} else {
var i = cljs.core.first(s__49052__$2);
var base = ((cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(i,(0)))?"rest__":["p",cljs.core.str.cljs$core$IFn$_invoke$arity$1(i),"__"].join(''));
var s = cljs.core.name(cljs.core.gensym.cljs$core$IFn$_invoke$arity$1(base));
return cljs.core.cons(cljs.core.symbol.cljs$core$IFn$_invoke$arity$1([s,"#"].join('')),rewrite_clj$node$fn$fn_walk_$_iter__49051(cljs.core.rest(s__49052__$2)));
}
} else {
return null;
}
...
var body = clojure.walk.prewalk((function (p1__49048_SHARP_){
var or__4185__auto__ = rewrite_clj.node.fn.symbol__GT_gensym(syms,vararg_QMARK_,max_n,p1__49048_SHARP_);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$ILookup$_lookup$arity$3 = (function (this__4441__auto__,k49064,else__4442__auto__){
var self__ = this;
...
break;
default:
return cljs.core.get.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k49064,else__4442__auto__);
...
var vec__49099 = p__49094;
var k__4462__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49099,(0),null);
var v__4463__auto__ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49099,(1),null);
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IIterable$_iterator$arity$1 = (function (G__49063){
var self__ = this;
var G__49063__$1 = this;
return (new cljs.core.RecordIter((0),G__49063__$1,1,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"children","children",-940561982)], null),(cljs.core.truth_(self__.__extmap)?cljs.core._iterator(self__.__extmap):cljs.core.nil_iter())));
}));
...
var h__4297__auto____$1 = (function (){var fexpr__49109 = (function (coll__4436__auto__){
return (-1740346885 ^ cljs.core.hash_unordered_coll(coll__4436__auto__));
});
return fexpr__49109(this__4435__auto____$1);
})();
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IEquiv$_equiv$arity$2 = (function (this49065,other49066){
var self__ = this;
var this49065__$1 = this;
return (((!((other49066 == null)))) && ((this49065__$1.constructor === other49066.constructor)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49065__$1.children,other49066.children)) && (cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(this49065__$1.__extmap,other49066.__extmap)));
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IAssociative$_assoc$arity$3 = (function (this__4446__auto__,k__4447__auto__,G__49063){
var self__ = this;
var this__4446__auto____$1 = this;
var pred__49136 = cljs.core.keyword_identical_QMARK_;
var expr__49137 = k__4447__auto__;
if(cljs.core.truth_((function (){var G__49139 = new cljs.core.Keyword(null,"children","children",-940561982);
var G__49140 = expr__49137;
return (pred__49136.cljs$core$IFn$_invoke$arity$2 ? pred__49136.cljs$core$IFn$_invoke$arity$2(G__49139,G__49140) : pred__49136.call(null,G__49139,G__49140));
})())){
return (new rewrite_clj.node.fn.FnNode(G__49063,self__.__meta,self__.__extmap,null));
} else {
return (new rewrite_clj.node.fn.FnNode(self__.children,self__.__meta,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(self__.__extmap,k__4447__auto__,G__49063),null));
}
}));
...
(rewrite_clj.node.fn.FnNode.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (this__4438__auto__,G__49063){
var self__ = this;
var this__4438__auto____$1 = this;
return (new rewrite_clj.node.fn.FnNode(self__.children,G__49063,self__.__extmap,self__.__hash));
}));
 ...
 */
rewrite_clj.node.fn.map__GT_FnNode = (function rewrite_clj$node$fn$map__GT_FnNode(G__49067){
var extmap__4478__auto__ = (function (){var G__49162 = cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__49067,new cljs.core.Keyword(null,"children","children",-940561982));
if(cljs.core.record_QMARK_(G__49067)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentArrayMap.EMPTY,G__49162);
} else {
return G__49162;
}
})();
return (new rewrite_clj.node.fn.FnNode(new cljs.core.Keyword(null,"children","children",-940561982).cljs$core$IFn$_invoke$arity$1(G__49067),null,cljs.core.not_empty(extmap__4478__auto__),null));
});
