...
var G__45702 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
ch = G__45702;
continue;
} else {
return ch;
...
var vec__45687 = cljs.core.re_find(pattern,s);
var match = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__45687,(0),null);
return (match === s);
});
...
var i__4790__auto___45721 = (0);
while(true){
if((i__4790__auto___45721 < len__4789__auto___45719)){
args__4795__auto__.push((arguments[i__4790__auto___45721]));

var G__45722 = (i__4790__auto___45721 + (1));
i__4790__auto___45721 = G__45722;
continue;
} else {
}
break;
...
/** @this {Function} */
(cljs.tools.reader.impl.commons.read_comment.cljs$lang$applyTo = (function (seq45697){
...
return (function() { 
var G__45725__delegate = function (rdr,_){
...
var G__45725 = function (rdr,var_args){
var _ = null;
if (arguments.length > 1) {
var G__45726__i = 0, G__45726__a = new Array(arguments.length -  1);
while (G__45726__i < G__45726__a.length) {G__45726__a[G__45726__i] = arguments[G__45726__i + 1]; ++G__45726__i;}
  _ = new cljs.core.IndexedSeq(G__45726__a,0,null);
} 
return G__45725__delegate.call(this,rdr,_);};
G__45725.cljs$lang$maxFixedArity = 1;
G__45725.cljs$lang$applyTo = (function (arglist__45727){
var rdr = cljs.core.first(arglist__45727);
var _ = cljs.core.rest(arglist__45727);
return G__45725__delegate(rdr,_);
});
